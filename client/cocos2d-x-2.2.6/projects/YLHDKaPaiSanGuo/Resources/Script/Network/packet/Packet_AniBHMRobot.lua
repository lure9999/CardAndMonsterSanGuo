module("Packet_AniBHMRobot",package.seeall)
...
function CreatePacket(  )
	...
	pNetStream:Write(C_MS_NET_MSG_ID.C_MS_GET_BAHAMUT_ROBOT )
	pNetStream:Write(0)
	pNetStream:Write(0)
...
function Server_Excute( PacketData )
	...
	if status == 1 then
		...
		server_AniBHMRobot.SetTableBuffer(PacketData)
...
PacketManage.RegistPacketFun(NET_MSG_TYPE_ID.TYPE_MS_C,MS_C_NET_MSG_ID.MS_C_GET_BAHAMUT_ROBOT ,Server_Excute)