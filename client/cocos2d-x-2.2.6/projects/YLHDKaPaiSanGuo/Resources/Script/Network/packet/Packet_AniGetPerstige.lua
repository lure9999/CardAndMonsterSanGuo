--获取灵兽声望信息
module("Packet_AniGetPerstige",package.seeall)
...
function CreatePacket(  )
	...
	pNetStream:Write(C_MS_NET_MSG_ID.C_MS_ANIMAL_GET_PRESTIGE )
	pNetStream:Write(0)
	pNetStream:Write(0)
...
function Server_Excute( PacketData )
	...
	if status == 1 then
		...
		server_AniPerstigeDB.SetTableBuffer(PacketData)
...
PacketManage.RegistPacketFun(NET_MSG_TYPE_ID.TYPE_MS_C,MS_C_NET_MSG_ID.MS_C_ANIMAL_GET_PRESTIGE ,Server_Excute)