--普通签到协议
module("Packet_SignInDaily",package.seeall)
...
function CreatePacket()
	...
	pNetStream:Write(C_MS_NET_MSG_ID.C_MS_SIGN_IN_GET_REWARD)
	pNetStream:Write(0)
	pNetStream:Write(0)
...
PacketManage.RegistPacketFun(NET_MSG_TYPE_ID.TYPE_MS_C,MS_C_NET_MSG_ID.MS_C_SIGN_IN_GET_REWARD,Server_Excute)