...
--require "Script/Fight/FightLayer"
require "Script/Fight/FightUILayer"
require "Script/Fight/FightResultLayer"

require "Script/Fight/FightbattleData"
require "Script/Fight/FightServer"
...
require "Script/Scene/scene_logic"
require "Script/Scene/scenemanage"
...
--战斗play调用的接口别人不能调用
function GetAniName_Player(pArmature , Ani_Key)
	
	local ipos = pArmature:getTag()
	if ipos ~= nil and BaseSceneDB.IsUser(ipos) == true then 
		local iResID = BaseSceneDB.GetPlayResID(ipos)	
